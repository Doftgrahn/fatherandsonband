...
var Scroll = function () {
  ...
  Scroll.prototype.removeHamburger = function removeHamburger() {
    this.hamburger = document.querySelector('.b-header__hamburgerContainer');
    this.wrapper = document.querySelector('.b-header__container');
