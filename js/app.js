...
var Concerts = function () {
  ...
  Concerts.prototype.checkIfDateHasPassed = function checkIfDateHasPassed() {
    var date = new Date();
    var concertDate = new Date(this.date);
    if (date < concertDate) {
      return true;
    } else {
      return false;
